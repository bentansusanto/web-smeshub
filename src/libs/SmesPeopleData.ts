export const heroSmesPeopleData = {
    heading: "Yuk gabung menjadi bagian dari SmesPeople!",
    subheading: "Join Sekarang Kedalam Komunitas Smespeople ",
    body: "Kamu bisa mendapatkan informasi terupdate dari berbagai kegiatan di Smeshub Indonesia. Kamu juga bisa berkesempatan mendapatkan mentoring secara langsung dari para SmesXpert.",
    client_success: "3,2m",
}
